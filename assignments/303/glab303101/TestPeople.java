...
public class TestPeople {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Boy.lifeSpan()); //uses parent class' lifespan where ageFactor = 1
        System.out.println(Girl.lifeSpan()); // uses Girl class's lifespan method, where ageFactor = 1.3
